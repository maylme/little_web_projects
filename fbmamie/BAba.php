...
?>
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a class="active" href="/BAba.php">
  ...
  <div class="container">
    ...
    <div class="container">
        ...
        <?php
        foreach ($lang["BAba"] as $article) {
          ?>
          <div class="row">
            <section id ="<?php print_r($article->ancre); ?>" class="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-10">
              <header>
                <h1><?php print_r($article->title); ?></h1>
                <div class="date"><?php print_r($article->date); ?></div>
                  <?php 
                  if (isset($article->header_img)) {
                    ?>
