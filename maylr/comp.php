...
?>
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a class="active" href="/comp.php"><span class ="nav_icon"><img src="/img/competences.svg"/></span>
    ...
    <div class="container">
        ...
        <div class="row">
          <section class="col-xs-offset-1 col-xs-10 col-sm-offset-1 col-sm-10">
            <header>
              <h1><?php print_r($lang["menu.travaux"]->title); ?></h1>
              <div class="date"><?php print_r($lang["menu.travaux"]->date); ?></div>
              <div class="header_img"><img src="<?php print_r($lang["menu.travaux"]->header_img); ?>"/>
              </div>
            </header>
            <article>
              <?php print_r($lang["menu.travaux"]->corps); ?>
            </article>
          </section>
        </div>
